    ...
    return (
        <section className='footer'>
            <div className='container'>
                <div className='row py-5 text-light  justify-content-center align-items-center'>
                    <div className='col-lg-4 col-md-6 mb-3'>
                        <div className='text-xs-start ps-5'>
                    ...
                    <div className='col-lg-4 col-md-6 pt-4 ps-md-5 categorie mb-3'>
                        <div className='text-light  text-md-start ps-md-5'>
                            <div className="titre">
                                <h5 className=''>Nos catégories</h5>
                                <div className='tiret'></div>
                            </div>
                            <ul className='ul  text-md-start'>
                    ...
                    <div className='col-lg-4 col-md-12 pt-4 ps-md-5 categorie mb-3'>
                        <div className='text-light text-md-start'>
                            <div className="titre">
