            ...
            <div className=" pt-3">
              <div className="timeline">
                <div className="timeline-item">
                  <div className="timeline-point timline1 d-flex align-items-center justify-content-center">
                    <span>1</span>{" "}
                  </div>
                ...
                <div className="timeline-item">
                  <div className="timeline-point timline2 d-flex align-items-center justify-content-center">
                    2
                  </div>
                  <div className="timeline-content">
